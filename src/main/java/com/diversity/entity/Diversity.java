...
public class Diversity{
    ...
    public Diversity(int id, String gender, String nationality, String religion, String maritialStatus, String sexualOrientation, String politicalOrientation, Enums.Color color, String language, boolean isLgbt, boolean isVeteran, boolean isDisable, long salary) {
        this.id = id;
        this.gender = gender;
